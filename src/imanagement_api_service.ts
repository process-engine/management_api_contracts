...
export interface IManagementApiService {
   ...
   *
   * @async
   * @param context The ManagementAPI specific ExecutionContext of the requesting user.
   ...
   * @async
   * @param context The ManagementAPI specific ExecutionContext of the requesting user.
   * @returns       A Promise, which resolves with the ProcessModel list, or rejects an error, in case the request failed.
   */
   ...
   * This can either be a specific EndEvent, or the first EndEvent encountered during execution.
   *
   * @async
   * @param context           The ManagementAPI specific ExecutionContext of the requesting user.
   * @param processModelId    The ID of the ProcessModel to retrieve.
   ...
   *                          after starting the Process Instance, or after reaching an EndEvent.
   * @param endEventId        Contains the ID of the EndEvent that the process engine should wait for, before resolving.
   ...
   *                          This can happen, if the ProcessModel was not found, or the user is not authorized to see it, or if
   ...
   * @async
   * @param context        The ManagementAPI specific ExecutionContext of the requesting user.
   * @param processModelId The ID of the ProcessModel for which to retrieve the events.
   * @returns              A Promise, which resolves with the retrieved events or rejects an error, in case the request failed.
   *                       This can happen, if the ProcessModel was not found, or the user is not authorized to see the it.
   */
   ...
   * @async
   * @param context        The ManagementAPI specific ExecutionContext of the requesting user.
   * @param processModelId The ID of the ProcessModel for which to retrieve the UserTasks.
   ...
   * @param processModelId The ID of the ProcessModel for which to retrieve the UserTasks.
   * @returns              A Promise, which resolves with the retrieved UserTasks, or rejects an error, in case the request failed.
   *                       This can happen, if the ProcessModel or correlation were not found, or the user is not authorized to see either.
   */
   ...
   * @async
   * @param context        The ManagementAPI specific ExecutionContext of the requesting user.
   * @param processModelId The ID of the ProcessModel for which to finish a UserTask.
   ...
   * @returns              The Runtime Informations pertaining to the given ProcessModel.
   */
 ...
 /**
   ...
   * @param context        The ManagementAPI specific ExecutionContext of the requesting user.
   * @param processModelId The ID of the ProcessModel.
   * @returns              A list of discovered active tokens for the given ProcessModel.
   */
   ...
   * @param processModelId The ID of ProcessModel for which to retrieve the logs.
